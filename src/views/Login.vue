...
const onSubmit = handleSubmit(async (values, { resetForm }) => {
    loading.value = true
    try {
        const result = await RestApi.post('login/v1/', values)
                ...
                <Form ref="myForm" @submit="onSubmit" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                    ...
                    <div class="pb-2 pt-4">
                        <input type="text" v-model="username" id="username" placeholder="Username"
                            class="login-input">
                        <p class="error-text text-left pl-5">{{ errors.username }}</p>
                    </div>
                    <div class="pb-2 pt-4">
                        <input type="password" v-model="password" id="password" placeholder="Password"
                            class="login-input">
                        <p class="error-text text-left pl-5">{{ errors.password }}</p>
                    </div>
                    <!--
                    ...
                    <div class="px-4 pb-2 pt-4">
                        <button type="submit"
                            class="uppercase block w-full p-3 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none">Login</button>
                    </div>
